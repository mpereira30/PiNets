...
def generateData():
	...
	y[0:echo_step] = 0
	x = x.reshape((batch_size, -1))  # -1 means the number of columns are automatically determined
...
with tf.Session() as sess:
	...
	for epoch_idx in range(num_epochs):
		...
		for batch_idx in range(num_batches):
			...
			# You can only input data to the placeholders trough the feed_dict as Python lists or Numpy arrays anyways (not as LSTMTuples)
